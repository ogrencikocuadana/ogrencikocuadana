...
// ─── SVG İkonlar (unchanged - all the same icons) ────────────────────────────
...
function PricingCard({ badge, icon, iconBg, title, features, checkColor, onOpen }: PricingCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Başlık */}
      <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.2rem", fontWeight: 700, color: "#0f1f4f", margin: "0 0 20px", lineHeight: 1.35 }}>{title}</h3>
      ...
      <button
        ...
        style={{
          ...
          background: hovered ? "#1e3a8a" : "white",
          color: hovered ? "white" : "#1e3a8a",
          border: "2px solid #1e3a8a",
          borderRadius: 10, fontWeight: 700, cursor: "pointer", marginTop: 24,
          transition: "all 0.25s ease", fontSize: "0.9rem",
        }}
      >
        Ön Görüşme İste
      </button>
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: 16, pointerEvents: "none" }}>
        <div onClick={(e) => e.stopPropagation()} style={{ background: "white", borderRadius: 20, width: "100%", maxWidth: 640, maxHeight: "92vh", overflowY: "auto", boxShadow: "0 28px 80px rgba(0,0,0,0.28)", animation: "modal-box-in 0.28s cubic-bezier(.22,.68,0,1.2)", pointerEvents: "all" }}>
          <div style={{ position: "sticky", top: 0, zIndex: 10, background: "linear-gradient(135deg, #1e3a8a 0%, #1e40af 100%)", padding: "24px 28px", borderRadius: "20px 20px 0 0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div><h2 className="display" style={{ fontSize: "1.65rem", fontWeight: 800, color: "white", margin: "0 0 4px" }}>Ücretsiz Ön Görüşme</h2><p style={{ color: "#bfdbfe", margin: 0, fontSize: "0.9rem" }}>Formu doldurun, en kısa sürede size dönelim</p></div>
            <button className="modal-close-btn" onClick={onClose} style={{ width: 42, height: 42, borderRadius: "50%", flexShrink: 0, background: "rgba(255,255,255,0.15)", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "background 0.2s", color: "white" }}><IconX /></button>
          </div>
          {submitted ? (
...
// ─── Geri Sayım — useEffect ile düzeltildi ───────────────────────────────────
          ...
          {exams.map((exam, i) => (
            <div key={i} className="card-hover" style={{ background: exam.bg, borderRadius: 18, padding: "24px 28px", border: `2px solid ${exam.border}`, display: "flex", alignItems: "center", gap: 20, boxShadow: "0 4px 16px rgba(0,0,0,0.05)" }}>
              <div style={{ textAlign: "center", flexShrink: 0, minWidth: 72 }}>
                <div style={{ fontSize: "3.2rem", fontWeight: 800, color: exam.color, lineHeight: 1, fontFamily: "var(--font-playfair), serif" }}>{days[i]}</div>
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 5 }}>
                  <span style={{ fontSize: "1.5rem", fontWeight: 800, color: exam.color, fontFamily: "var(--font-playfair), serif" }}>{exam.name}</span>
...
export default function OgrenciKocuAdana() {
  ...
  const schemaData = {"@context":"https://schema.org","@type":"EducationalOrganization","name":"Öğrenci Koçu Adana","description":"LGS ve YKS öğrencileri için yapılandırılmış Akademik Performans ve Psikolojik Dayanıklılık Modeli","url":"https://ogrencikocuadana.com","logo":"https://ogrencikocuadana.com/og-image.png","image":"https://ogrencikocuadana.com/og-image.png","telephone":["+905473803801","+905403803801"],"email":"ogrencikocuadana@gmail.com","address":{"@type":"PostalAddress","addressLocality":"Adana","addressCountry":"TR"},"openingHoursSpecification":[{"@type":"OpeningHoursSpecification","dayOfWeek":["Monday","Tuesday","Wednesday","Thursday","Friday"],"opens":"10:00","closes":"20:00"},{"@type":"OpeningHoursSpecification","dayOfWeek":"Saturday","opens":"10:00","closes":"17:00"}],"priceRange":"₺₺","areaServed":{"@type":"City","name":"Adana"}};
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: "white" }}>
        ...
        {/* ══════════════════════ HERO ══════════════════════ */}
        <section style={{ background: "linear-gradient(150deg, #ffffff 0%, #eef4ff 45%, #fff8f3 100%)", padding: "130px 16px 110px", position: "relative", overflow: "hidden" }}>
          <div className="dot-bg" style={{ position: "absolute", inset: 0, opacity: 0.03 }} />
          <div style={{ position: "absolute", top: -120, right: -80, width: 500, height: 500, background: "radial-gradient(circle, rgba(30,58,138,0.07) 0%, transparent 70%)", pointerEvents: "none" }} />
          <div style={{ position: "absolute", bottom: -80, left: -60, width: 400, height: 400, background: "radial-gradient(circle, rgba(194,65,12,0.05) 0%, transparent 70%)", pointerEvents: "none" }} />
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center", position: "relative" }}>
            ...
            {/* Ana başlık */}
            <h1 className="display hero-h1" style={{ fontSize: "clamp(2.2rem, 5vw, 3.8rem)", fontWeight: 800, color: "#0f1f4f", lineHeight: 1.18, marginBottom: 28, maxWidth: 820, margin: "0 auto 28px" }}>
              Sınav Başarısı{" "}
              <span style={{ color: "#1d4ed8" }}>Tesadüf</span> Değil,<br />
        ...
        <section style={{ padding: "88px 16px", background: "white" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <h2 className="display" style={{ fontSize: "clamp(1.8rem, 4vw, 2.6rem)", fontWeight: 800, color: "#0f1f4f", marginBottom: 12 }}>Tanıdık Geliyor mu?</h2>
            ...
            <div className="grid-cols-2" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 28, marginBottom: 28 }}>
              <div className="card-hover" style={{ background: "#eff6ff", borderRadius: 20, padding: 32, border: "2px solid #bfdbfe" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
                  <div style={{ width: 48, height: 48, background: "#1e3a8a", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center" }}><IconUsers style={{ width: 24, height: 24, color: "white" }} /></div>
                  <h3 className="display" style={{ fontSize: "1.4rem", fontWeight: 700, color: "#0f1f4f", margin: 0 }}>Velilerden Duyuyoruz</h3>
                </div>
                {[{ Icon: IconTrendingDown, text: "Çalışıyor ama verimsiz geçiyor" }, { Icon: IconBrain, text: "Denemede netleri artmıyor" }, { Icon: IconAlertCircle, text: "Kaygı ve telefon dikkatini bölüyor" }, { Icon: IconTrendingDown, text: "Programlı çalışmıyor" }].map(({ Icon, text }, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: 14 }}>
                    <div style={{ padding: 8, background: "white", borderRadius: 8, flexShrink: 0 }}><Icon style={{ width: 18, height: 18, color: "#1d4ed8" }} /></div>
              ...
              <div className="card-hover" style={{ background: "#fff7ed", borderRadius: 20, padding: 32, border: "2px solid #fed7aa" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
                  <div style={{ width: 48, height: 48, background: "#c2410c", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center" }}><IconBook style={{ width: 24, height: 24, color: "white" }} /></div>
                  <h3 className="display" style={{ fontSize: "1.4rem", fontWeight: 700, color: "#0f1f4f", margin: 0 }}>Öğrencilerden Duyuyoruz</h3>
                </div>
                {[{ Icon: IconAlertCircle, text: "Nereden başlayacağımı bilmiyorum" }, { Icon: IconTrendingDown, text: "Motivasyonum dalgalı" }, { Icon: IconBrain, text: "Netlerim bir türlü artmıyor" }, { Icon: IconSmartphone, text: "Denemede bildiğimi yapamıyorum" }].map(({ Icon, text }, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: 14 }}>
                    <div style={{ padding: 8, background: "white", borderRadius: 8, flexShrink: 0 }}><Icon style={{ width: 18, height: 18, color: "#c2410c" }} /></div>
                    <p style={{ color: "#374151", lineHeight: 1.6, margin: 0, fontSize: "0.95rem" }}>{text}</p>
                  </div>
                ))}
              </div>
            ...
            <div style={{ background: "linear-gradient(90deg, #1e3a8a, #1e40af)", borderRadius: 16, padding: "26px 32px", textAlign: "center", boxShadow: "0 8px 32px rgba(30,58,138,0.25)" }}>
              <p style={{ fontSize: "1.15rem", color: "white", fontWeight: 600, margin: 0 }}>Sorun bilgi eksikliği değil,{" "}<span style={{ color: "#fdba74", fontWeight: 800 }}>sistem ve psikolojik dayanıklılık eksikliği.</span></p>
            </div>
          </div>
        </section>

        {/* ══════════════════════ MODEL ══════════════════════ */}
        <section id="sistemimiz" style={{ padding: "88px 16px", background: "linear-gradient(135deg, #f8faff, #eff6ff)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <h2 className="display" style={{ fontSize: "clamp(1.8rem, 4vw, 3rem)", fontWeight: 800, color: "#0f1f4f", marginBottom: 12 }}>Akademik Performans ve<br />Psikolojik Dayanıklılık Modeli</h2>
            ...
            <div className="grid-cols-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 28 }}>
              {[
                ...
                <div key={i} className="card-hover" style={{ background: col.cardBg, borderRadius: 20, padding: 30, border: `2px solid ${col.border}` }}>
                  <div style={{ width: 60, height: 60, background: col.iconBg, borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20, boxShadow: "0 4px 14px rgba(0,0,0,0.18)" }}>{col.icon}</div>
                  <h3 className="display" style={{ fontSize: "1.25rem", fontWeight: 700, color: col.titleColor, marginBottom: 18, lineHeight: 1.3 }}>{col.title}</h3>
            ...
            <div style={{ marginTop: 40, background: "white", borderRadius: 16, padding: "24px 32px", border: "2px solid #fed7aa", display: "flex", alignItems: "center", justifyContent: "center", gap: 16, flexWrap: "wrap" }}>
              <div style={{ width: 44, height: 44, background: "#ffedd5", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}><IconUsers style={{ width: 22, height: 22, color: "#c2410c" }} /></div>
        ...
        {/* ══════════════════════ PAKETLER ══════════════════════ */}
        <section id="paketler" style={{ padding: "88px 16px 96px", background: "linear-gradient(180deg, white 0%, #f8faff 100%)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div className="pricing-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.15fr 1fr", gap: 20, alignItems: "start" }}>
              ...
              {/* Önerilen kart — merkez */}
              <div style={{ position: "relative", marginTop: -8 }}>
                {/* Parlayan arka plan halkası */}
                <div style={{ position: "absolute", inset: -3, borderRadius: 28, background: "linear-gradient(135deg, #f97316, #1e40af, #f97316)", backgroundSize: "200% 200%", zIndex: 0, filter: "blur(1px)", opacity: 0.7 }} />

                <div style={{ position: "relative", zIndex: 1, background: "linear-gradient(160deg, #1e3a8a 0%, #1e40af 60%, #1a35a0 100%)", borderRadius: 26, padding: "40px 32px 32px", boxShadow: "0 20px 60px rgba(30,58,138,0.35), 0 0 0 1px rgba(255,255,255,0.08) inset" }}>
                  ...
                  {/* İkon */}
                  <div style={{ width: 56, height: 56, background: "rgba(255,255,255,0.12)", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16, border: "1px solid rgba(255,255,255,0.2)" }}>
                    <IconStar style={{ width: 28, height: 28, color: "#fdba74" }} />
                  </div>

                  {/* Başlık */}
                  <h3 className="display" style={{ fontSize: "1.2rem", fontWeight: 700, color: "white", margin: "0 0 8px", lineHeight: 1.35 }}>
                  ...
                  {[
                    ...
                    <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 11 }}>
                      <div style={{ width: 20, height: 20, borderRadius: "50%", background: f.highlight ? "rgba(253,186,116,0.25)" : "rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>
        ...
        {/* ══════════════════════ SÜREÇ ══════════════════════ */}
        <section style={{ padding: "88px 16px", background: "linear-gradient(135deg, #f0f4ff, #ffffff, #fff7ed)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <div style={{ display: "inline-block", marginBottom: 14, padding: "7px 18px", background: "#dbeafe", borderRadius: 9999 }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              {[
                ...
                <div key={step.num} className="timeline-grid" style={{ display: "grid", gridTemplateColumns: "1fr 80px 1fr", alignItems: "center", gap: 28, marginBottom: 44, position: "relative", zIndex: 1 }}>
                  <div>{!step.right && <div className="card-hover" style={{ background: "white", borderRadius: 18, padding: 26, border: "2px solid #bfdbfe", boxShadow: "0 4px 16px rgba(0,0,0,0.05)" }}><h3 className="display" style={{ fontSize: "1.2rem", fontWeight: 700, color: "#0f1f4f", marginBottom: 8 }}>{step.title}</h3><p style={{ color: "#4b5563", lineHeight: 1.65, margin: 0, fontSize: "0.9rem" }}>{step.desc}</p></div>}</div>
                  <div className="timeline-center" style={{ display: "flex", justifyContent: "center" }}>
                    <div style={{ width: 76, height: 76, background: "linear-gradient(135deg, #1e3a8a, #1e40af)", borderRadius: 16, display: "flex", alignItems: "center", justifyContent: "center", border: "4px solid white", boxShadow: "0 8px 24px rgba(30,58,138,0.28)", position: "relative" }}>
                      {step.icon}
                      <div style={{ position: "absolute", top: -10, right: -10, width: 26, height: 26, background: "#f97316", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 700, fontSize: "0.78rem", boxShadow: "0 2px 8px rgba(249,115,22,0.4)" }}>{step.num}</div>
                    </div>
                  </div>
                  <div>{step.right && <div className="card-hover" style={{ background: "white", borderRadius: 18, padding: 26, border: "2px solid #bfdbfe", boxShadow: "0 4px 16px rgba(0,0,0,0.05)" }}><h3 className="display" style={{ fontSize: "1.2rem", fontWeight: 700, color: "#0f1f4f", marginBottom: 8 }}>{step.title}</h3><p style={{ color: "#4b5563", lineHeight: 1.65, margin: 0, fontSize: "0.9rem" }}>{step.desc}</p></div>}</div>
                </div>
        ...
        {/* ══════════════════════ PERFORMANS SİSTEMİ ══════════════════════ */}
        <section style={{ padding: "88px 16px", background: "linear-gradient(135deg, #1e3a8a, #1e40af)", position: "relative", overflow: "hidden" }}>
          <div className="dot-bg" style={{ position: "absolute", inset: 0, opacity: 0.09 }} />
          <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" }}>
            ...
            <div className="grid-cols-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 28, marginBottom: 48 }}>
              {[
                ...
                <div key={i} className="card-hover" style={{ background: "rgba(255,255,255,0.09)", borderRadius: 20, padding: 30, border: "1px solid rgba(255,255,255,0.18)", backdropFilter: "blur(8px)" }}>
                  <div style={{ width: 60, height: 60, background: "#f97316", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 22, boxShadow: "0 4px 14px rgba(249,115,22,0.4)" }}>{item.icon}</div>
                  <h3 className="display" style={{ fontSize: "1.35rem", fontWeight: 700, color: "white", marginBottom: 10 }}>{item.title}</h3>
                  <p style={{ color: "#bfdbfe", lineHeight: 1.65, margin: 0, fontSize: "0.92rem" }}>{item.desc}</p>
                </div>
              ))}
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
              <IconCheckCircle style={{ width: 30, height: 30, color: "#fdba74" }} />
              <p style={{ fontSize: "1.15rem", fontWeight: 600, color: "white", margin: 0 }}>Sistem + Disiplin + Psikolojik Dayanıklılık = <span style={{ color: "#fdba74" }}>Başarı</span></p>
            </div>
          </div>
        </section>
            ...
            <div className="grid-cols-2" style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 40 }}>
              <div className="card-hover" style={{ background: "linear-gradient(135deg, #eff6ff, white)", borderRadius: 20, padding: 40, border: "2px solid #bfdbfe", boxShadow: "0 4px 16px rgba(0,0,0,0.05)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 22 }}>
                  <div style={{ width: 60, height: 60, background: "#1e3a8a", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 14px rgba(30,58,138,0.28)" }}><IconUsers style={{ width: 30, height: 30, color: "white" }} /></div>
                  <h3 className="display" style={{ fontSize: "1.9rem", fontWeight: 700, color: "#0f1f4f", margin: 0 }}>Sayın Veli</h3>
                </div>
                ...
                <div style={{ background: "white", borderRadius: 12, padding: 22, border: "1px solid #bfdbfe", marginBottom: 22 }}>
                  {[{ icon: <IconHeart style={{ width: 22, height: 22, color: "#2563eb" }} />, text: <span>Her ay <strong style={{ color: "#1e3a8a" }}>detaylı performans raporu</strong> sunuyoruz.</span> }, { icon: <IconTarget style={{ width: 22, height: 22, color: "#2563eb" }} />, text: <span>Süreç <strong style={{ color: "#1e3a8a" }}>şeffaf ve ölçülebilir.</strong></span> }].map((item, i) => (
                    <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: i === 0 ? 12 : 0 }}><span style={{ flexShrink: 0, marginTop: 2 }}>{item.icon}</span><p style={{ color: "#374151", lineHeight: 1.6, margin: 0 }}>{item.text}</p></div>
                  ))}
                </div>
              ...
              <div className="card-hover" style={{ background: "linear-gradient(135deg, #fff7ed, white)", borderRadius: 20, padding: 40, border: "2px solid #fed7aa", boxShadow: "0 4px 16px rgba(0,0,0,0.05)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 22 }}>
                  <div style={{ width: 60, height: 60, background: "#c2410c", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 14px rgba(194,65,12,0.28)" }}><IconBookOpen style={{ width: 30, height: 30, color: "white" }} /></div>
                  <h3 className="display" style={{ fontSize: "1.9rem", fontWeight: 700, color: "#0f1f4f", margin: 0 }}>Sevgili Öğrenci</h3>
                </div>
                ...
                <div style={{ background: "white", borderRadius: 12, padding: 22, border: "1px solid #fed7aa", marginBottom: 22 }}>
                  {[{ n: 1, text: "Seni sisteme alırız" }, { n: 2, text: "Takip ederiz" }, { n: 3, text: "Geliştiririz" }].map((item) => (
                    <div key={item.n} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}><div style={{ width: 30, height: 30, background: "#ea580c", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: 700, flexShrink: 0, fontSize: "0.85rem" }}>{item.n}</div><p style={{ color: "#374151", fontWeight: 500, margin: 0 }}>{item.text}</p></div>
                  ))}
                </div>
        ...
        {/* ══════════════════════ YORUMLAR ══════════════════════ */}
        <section style={{ padding: "88px 0", background: "linear-gradient(135deg, #f8faff, #eff6ff)", overflow: "hidden" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 48, padding: "0 16px" }}>
              ...
              <h2 className="display" style={{ fontSize: "clamp(1.8rem, 4vw, 3rem)", fontWeight: 800, color: "#0f1f4f", marginBottom: 12 }}>Veli ve Öğrenciler Ne Diyor?</h2>
        ...
        {/* ══════════════════════ CTA ══════════════════════ */}
        <section id="İletişim" style={{ padding: "96px 16px", background: "linear-gradient(135deg, #1e3a8a, #1e40af, #1e3a8a)", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", top: 0, right: 0, width: 360, height: 360, background: "rgba(249,115,22,0.18)", borderRadius: "50%", filter: "blur(64px)" }} />
          <div style={{ position: "absolute", bottom: 0, left: 0, width: 360, height: 360, background: "rgba(30,64,175,0.28)", borderRadius: "50%", filter: "blur(64px)" }} />
          <div className="dot-bg" style={{ position: "absolute", inset: 0, opacity: 0.09 }} />
          <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center", position: "relative" }}>
            <h2 className="display" style={{ fontSize: "clamp(1.8rem, 4vw, 3rem)", fontWeight: 800, color: "white", lineHeight: 1.3, marginBottom: 22 }}>
            ...
            <button onClick={openModal} className="btn-main" style={{ background: "white", color: "#1e3a8a", border: "none", padding: "18px 44px", borderRadius: 12, fontWeight: 700, fontSize: "1.1rem", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 12, margin: "0 auto", boxShadow: "0 8px 32px rgba(0,0,0,0.28)", transition: "all 0.25s" }}>
              ...
              <IconArrowRight style={{ width: 22, height: 22 }} />
            </button>
        ...
        <footer style={{ background: "linear-gradient(135deg, #0f1f4f, #1e3a8a)", color: "white" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "52px 16px" }}>
            <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32, marginBottom: 32 }}>
              <div>
                <h3 className="display" style={{ fontSize: "1.45rem", fontWeight: 700, color: "#fdba74", marginBottom: 14 }}>Öğrenci Koçu Adana</h3>
              ...
              <div>
                <h4 style={{ fontWeight: 700, fontSize: "1rem", color: "#fdba74", margin: "0 0 14px" }}>İletişim</h4>
                {[{ Icon: IconPhone, text: "0547 380 38 01" }, { Icon: IconPhone, text: "0540 380 38 01" }, { Icon: IconMail, text: "ogrencikocuadana@gmail.com" }, { Icon: IconMapPin, text: "Adana, Türkiye" }].map(({ Icon, text }, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 11, color: "#bfdbfe" }}><Icon style={{ width: 18, height: 18, flexShrink: 0 }} /><span style={{ fontSize: "0.9rem" }}>{text}</span></div>
                ))}
              </div>
              <div>
                <h4 style={{ fontWeight: 700, fontSize: "1rem", color: "#fdba74", margin: "0 0 14px" }}>Çalışma Saatleri</h4>
            ...
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 22, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
              ...
              <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.83rem", margin: 0, display: "flex", alignItems: "center", gap: 8 }}>Başarı için sistematik yaklaşım <IconHeart style={{ width: 14, height: 14, color: "#fb923c" }} filled /></p>
            </div>
          </div>
        </footer>
        ...
        <a href="https://wa.me/905473803801?text=Merhaba,%20bilgi%20almak%20istiyorum" target="_blank" rel="noopener noreferrer">
          <button aria-label="WhatsApp ile iletişime geç" style={{ position: "fixed", bottom: 24, right: 24, zIndex: 9999, width: 62, height: 62, background: "#22c55e", border: "none", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0 8px 24px rgba(34,197,94,0.4)", transition: "all 0.3s ease" }}>
            <IconMessageCircle style={{ width: 30, height: 30, color: "white" }} />
            <span style={{ position: "absolute", top: -4, right: -4, width: 15, height: 15, background: "#ef4444", borderRadius: "50%" }} />
            <span className="ping" style={{ position: "absolute", top: -4, right: -4, width: 15, height: 15, background: "#ef4444", borderRadius: "50%" }} />
          </button>
        </a>
