  ...
  while (i < lines.length) {
    ...
    if (line.startsWith("## ")) {
      ...
      elements.push(
        <hr
          key={i}
          style={{ border: "none", borderTop: "2px solid #f3f4f6", margin: "40px 0" }}
        />
      );
    } else if (line.startsWith("| ")) {
...
export default async function BlogPostPage({
  ...
  // Article JSON-LD — her yazı için dinamik
  const articleJsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://ogrencikocuadana.com/blog/${post!.slug}`,
    },
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: post!.title,
        item: `https://ogrencikocuadana.com/blog/${post!.slug}`,
      },
    ],
  };
  ...
  return (
    <main style={{ minHeight: "100vh", background: "white" }}>
      ...
      <div
        style={{
          background: "linear-gradient(150deg, #0f1f4f, #1e3a8a)",
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "60px 16px 0" }}>
        ...
        >
          ...
          >
            Ücretsiz ön görüşmede mevcut durumunuzu değerlendirir, size özel bir yol
            haritası çiziriz.
          </p>
          <Link
            href="/#İletişim"
